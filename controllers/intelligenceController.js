...
const { z } = require('zod');
const { sanitizeInput, generateEmbedding, generateEmbeddingsBatch, openai } = require('../services/aiService');
...
exports.streamChat = async (req, res) => {
    try {
        ...
        logger.info('💬 Chat request:', { query: query.substring(0, 50), nodeId, conversationId });
