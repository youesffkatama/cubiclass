...
export const NotificationSystem = {
    ...
    remove: async (id) => {
        try {
            ...
            NotificationSystem.notifications = NotificationSystem.notifications.filter(n => n._id !== id);
            NotificationSystem.openPanel();
            ...
            if (badge && NotificationSystem.notifications.length === 0) {
                ...
                badge.textContent = NotificationSystem.notifications.filter(n => !n.read).length;
            }
        } catch (error) {
